...
## 隐藏消灭提示    Disable Kill Feed

_隐藏一名或多名玩家的消灭提示,直到重新被显示为止._

- `玩家`: 下列玩家的消灭提示将被隐藏.



## 显示消灭提示    Enable Kill Feed
...
## 隐藏信息    Disable Messages

_隐藏一名或多名玩家的信息, 直到重新被显示为止._

- `玩家`: 下列玩家的信息将被隐藏.



## 显示信息    Enable Messages
...
## 隐藏计分板    Disable Scoreboard

_隐藏一名或多名玩家的计分板,直到重新被显示为止._

- `玩家`: 下列玩家的计分板将被隐藏.



## 显示计分板    Enable Scoreboard
...
## 开始修改英雄语音    Start Modifying Hero Voice Lines

_修改玩家的英雄语音声音._

- `玩家`: 下列玩家的英雄语音声音将被修改.
- `音调调整`: 语音的音调提高 (最高值1.5) 或降低 (最低指0.5) 的值.
- `重新赋值`: 如果此值为真, 那么每一帧都会重新计算音调调整的值. 如果此值为假, 则只会再次行动一开始时赋予一个值.



## 停止修改英雄语音    Stop Modifying Hero Voice Lines

_取消 “开始修改英雄语音” 动作的效果._

- `玩家`: 下列玩家的英雄语音声音将停止被修改.
